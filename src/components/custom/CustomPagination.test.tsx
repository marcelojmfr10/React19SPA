...
describe("CustomPagination", () => {
  ...
  test("should disabled next button when we are in the last page", () => {
    renderWithRouter(<CustomPagination totalPages={7} />, ["/?page=7"]);
    const nextButton = screen.getByText("Siguientes");
    expect(nextButton.getAttributeNames()).toContain("disabled");
  });

  test("should disabled button 3 we are in page 3", () => {
  ...
  test("should chnage page when click on number button", () => {
