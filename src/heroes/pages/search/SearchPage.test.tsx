...
describe("SearchPage", () => {
  ...
  test("should call search actions with name parameter", () => {
    const { container } = renderSearchPage(["/search?name=batman"]);
  ...
  test("should call search actions with strength parameter", () => {
  ...
  test("should call search actions with strength and name parameters", () => {
    const { container } = renderSearchPage([
